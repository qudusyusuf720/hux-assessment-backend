# auth-backend
This Backend repository project implements a backend for user authentication through a sign in and sign up page that is implemented in the Frontend and uses JWT for authentication. 
